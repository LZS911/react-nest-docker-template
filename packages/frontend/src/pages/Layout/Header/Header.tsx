...
const Header: React.FC = () => {
  ...
  return (
    <header
      ref={ref}
      className="sticky top-0 right-0 z-[1000] border-b border-warmGray-100 dark:border-stone-800"
    >
      <ThemeBase.Paper
        className={`flex w-full items-center justify-between py-2 pr-6 pl-2`}
      >
        <ThemeBase.Icon
